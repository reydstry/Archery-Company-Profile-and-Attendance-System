        ...
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
                ...
                <span class="shine"></span>
                    ...
                    <?php echo e(__('home.contact_whatsapp')); ?>
                ...
                onmouseleave="this.classList.remove('is-hovered')">
                <span class="shine"></span>
                    <?php echo e(__('home.view_full_info')); ?>
...
<?php /**PATH C:\laragon\www\Project\club-panahan\resources\views\components\home\cta-section.blade.php ENDPATH**/ ?>