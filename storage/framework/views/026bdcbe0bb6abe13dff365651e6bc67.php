                                ...
                                <div class="p-5 flex flex-col flex-1">
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div class="liquid-glass relative flex items-center gap-3 px-4 py-2.5 transition-transform duration-300"
                                             ...
                                             onmouseleave="this.classList.remove('is-hovered')">
                                            <span class="shine"></span>
                                            <span class="text-xl relative z-10"><?php echo e($award['medal']); ?></span>
                                            <span class="text-white/80 text-xs sm:text-sm leading-snug relative z-10"><?php echo e($award['title']); ?></span>
                                        </div>
...
<?php /**PATH C:\laragon\www\Project\club-panahan\resources\views/components/tentang-kami/achievements.blade.php ENDPATH**/ ?>