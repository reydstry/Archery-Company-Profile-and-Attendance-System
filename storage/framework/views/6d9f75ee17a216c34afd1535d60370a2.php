...
<div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
    <div class="flex items-center justify-between gap-3 px-5 py-3.5 bg-[#1a307b] border-b border-slate-100">
        <div class="flex items-center gap-2.5">
            ...
            <h3 class="text-sm font-semibold text-white">Form Broadcast</h3>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project\club-panahan\resources\views\dashboards\admin\whatsapp\broadcast.blade.php ENDPATH**/ ?>