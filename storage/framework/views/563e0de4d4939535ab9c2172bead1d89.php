<?php $__env->startSection('title', $news->title . ' - FocusOneX Archery'); ?>
...
<div class="min-h-screen bg-gradient-to-b from-[#1b2659] via-[#0f172a] to-[#16213a]">
    ...
    <div class="relative h-[50vh] md:h-[60vh] overflow-hidden">
        <!-- Background Image -->
        <img src="<?php echo e($news->photo_url ?? asset('asset/img/latarbelakanglogin.jpeg')); ?>" 
            ...
            <div class="container mx-auto px-6">
                ...
                <div class="flex flex-wrap items-center gap-4 text-gray-300">
                    <div class="flex items-center gap-2">
                        ...
                        <time datetime="<?php echo e($news->publish_date->format('Y-m-d')); ?>">
                            <?php echo e($news->publish_date->format('d F Y')); ?>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span><?php echo e(number_format(rand(150, 1500))); ?> views</span>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project\club-panahan\resources\views/pages/news-detail.blade.php ENDPATH**/ ?>