...
<section class="bg-gradient-to-br from-gray-50 to-white py-20 mt-20">
    ...
    <h1 class="text-4xl font-bold text-gray-900 mb-3"><?php echo e(__('gallery.header_title')); ?></h1>
    <p class="text-gray-600"><?php echo e(__('gallery.header_subtitle')); ?></p>
</div>
...
<?php /**PATH C:\laragon\www\Project\club-panahan\resources\views/components/galeri/header.blade.php ENDPATH**/ ?>