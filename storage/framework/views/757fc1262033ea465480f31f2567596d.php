<?php $__env->startSection('title', 'Set Password - FocusOneX Archery'); ?>
...
<section class="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
    ...
    <div class="relative z-10 w-full max-w-lg sm:max-w-xl lg:max-w-4xl
        ...
        <div class="flex justify-center mb-6">
            <img src="<?php echo e(asset('asset/img/logofocus.png')); ?>"
                 alt="FocusOneX"
                 class="h-12 w-auto">
        </div>
        ...
        <!-- Form -->
        <form method="POST" action="<?php echo e(route('password.store')); ?>" class="mt-8 space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <input type="tel" 
                       ...
                       class="w-full rounded-lg border border-gray-300 px-4 py-3 text-sm
                              focus:border-blue-500 focus:ring-2 focus:ring-blue-500 <?php $__errorArgs = ['phone'];
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project\club-panahan\resources\views\auth\set-password.blade.php ENDPATH**/ ?>