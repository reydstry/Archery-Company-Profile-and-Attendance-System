    ...
    <div class="container mx-auto px-6 relative z-10">
        ...
        <div class="text-center mb-12 sm:mb-16">
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">
                <?php echo e(__('contact.page_title')); ?>
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div class="liquid-glass p-8">
                <h3 class="text-2xl font-bold text-white mb-2"><?php echo e(__('contact.send_message_title')); ?></h3>
                ...
                <form id="contactForm" onsubmit="return false;" class="space-y-5">
                    ...
                    <div>
                        <label for="<?php echo e($field['id']); ?>" class="block text-sm font-medium text-white/70 mb-2">
                            <?php echo e($field['label']); ?> <?php if($field['required']): ?><span class="text-red-400">*</span><?php endif; ?>
                        </label>
                        <input 
                    ...
                    <div>
                        <label for="program" class="block text-sm font-medium text-white/70 mb-2">
                            <?php echo e(__('contact.program_interest')); ?> <span class="text-red-400">*</span>
                        </label>
                        <select 
                            id="program" 
                            name="program" 
                        ...
                        >
                            <option value=""           class="bg-[#1b2659]"><?php echo e(__('contact.select_program')); ?></option>
                            <option value="pemula"     class="bg-[#1b2659]"><?php echo e(__('contact.program_beginner')); ?></option>
                            <option value="menengah"   class="bg-[#1b2659]"><?php echo e(__('contact.program_intermediate')); ?></option>
                            <option value="advanced"   class="bg-[#1b2659]"><?php echo e(__('contact.program_advanced')); ?></option>
                            <option value="kompetisi"  class="bg-[#1b2659]"><?php echo e(__('contact.program_competition')); ?></option>
                            <option value="privat"     class="bg-[#1b2659]"><?php echo e(__('contact.program_private')); ?></option>
                        </select>
                    </div>
            ...
            <div class="liquid-glass p-8 h-full">
                ...
                <h3 class="text-2xl font-bold text-white mb-2"><?php echo e(__('contact.contact_info')); ?></h3>
                ...
                <div class="space-y-4 mb-8">
                    ...
                    <div class="flex items-start gap-4 bg-white/5 border border-white/10 rounded-xl px-4 py-3.5">
                        <div class="w-10 h-10 flex-shrink-0 bg-<?php echo e($info['color']); ?>-500/20 border border-white/20 
                                    rounded-xl flex items-center justify-center shadow-lg shadow-<?php echo e($info['color']); ?>-500/10">
                            <svg class="w-5 h-5 text-<?php echo e($info['color']); ?>-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($info['icon']); ?>"/>
                            </svg>
                        </div>
                        <div>
                            <p class="text-white/50 text-xs font-semibold uppercase tracking-wider mb-1"><?php echo e($info['label']); ?></p>
                            <?php $__currentLoopData = $info['lines']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <p class="text-white/80 text-sm"><?php echo e($line); ?></p>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div>
                    <p class="text-white/50 text-xs font-semibold uppercase tracking-wider mb-3">
                        <?php echo e(app()->getLocale() == 'id' ? 'Ikuti Kami' : 'Follow Us'); ?>
...
</script><?php /**PATH C:\laragon\www\Project\club-panahan\resources\views/components/kontak/hero-section.blade.php ENDPATH**/ ?>