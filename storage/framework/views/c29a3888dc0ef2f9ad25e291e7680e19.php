        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-3">
                    <img src="<?php echo e(asset('asset/img/logofocus.png')); ?>" alt="FocusOneX" class="h-10">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition
                        ...
                        <a href="<?php echo e(route('member.profile')); ?>" class="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-700 hover:bg-slate-50 transition">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
<?php /**PATH C:\laragon\www\Project\club-panahan\resources\views\dashboards\member\dashboard.blade.php ENDPATH**/ ?>