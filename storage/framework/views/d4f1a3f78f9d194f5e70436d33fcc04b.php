        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
            ...
            <div class="relative group">
                ...
                <div class="liquid-glass relative h-full transition-transform duration-500 hover:scale-105"
                    ...
                    <div class="<?php echo e($product['bg']); ?> border-b border-white/10 px-6 py-5 flex items-center gap-3">
                        <div class="w-11 h-11 backdrop-blur-sm border border-white/20 rounded-2xl 
                                    flex items-center justify-center">
                            <svg class="w-5 h-5 <?php echo e($product['text']); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($product['icon']); ?>"/>
                            </svg>
                        </div>
                        <h3 class="text-sm sm:text-base font-bold text-white leading-tight"><?php echo e($product['name']); ?></h3>
                    </div>

                    
                    <div class="px-6 pt-4 pb-2">
                        <p class="text-white/60 text-sm leading-relaxed"><?php echo e($product['desc']); ?></p>
                    </div>
                    ...
                    <ul class="px-6 pb-6 mt-3 space-y-2 flex-1">
                        ...
                        <li class="flex items-center gap-2 text-xs text-white/70">
                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($product['dot']); ?> flex-shrink-0"></span>
                            <?php echo e($item); ?>
...
<?php /**PATH C:\laragon\www\Project\club-panahan\resources\views\components\tentang-kami\toko.blade.php ENDPATH**/ ?>