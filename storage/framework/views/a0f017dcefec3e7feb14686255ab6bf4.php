    ...
    <div class="flex min-h-screen">
        ...
        <aside class="fixed left-0 top-0 h-screen w-64 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 border-r border-slate-700 z-50 transition-transform duration-300 overflow-y-auto"
            ...
            <div class="p-6 border-b border-slate-700/50 sticky top-0 bg-slate-900/95 backdrop-blur-sm z-10">
                <img src="<?php echo e(asset('asset/img/logodasboard.png')); ?>" alt="FocusOneX Archery" class="h-16 sm:h-20 w-auto">
            </div>

            <!-- Navigation -->
            <nav class="p-4 space-y-1">
                <a href="<?php echo e(route('member.dashboard')); ?>"
                   class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-semibold transition-all <?php echo e(request()->routeIs('member.dashboard') ? 'bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg' : 'text-slate-300 hover:bg-white/10 hover:text-white'); ?>">
                ...
                <div class="pt-4">
                    <form method="POST" action="<?php echo e(route('logout')); ?>">
                        <?php echo csrf_field(); ?>
                        <button type="submit" class="flex items-center gap-3 w-full px-4 py-3 rounded-xl text-sm font-semibold transition-all text-slate-300 hover:bg-red-500/10 hover:text-red-400">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <main class="flex-1 ml-64 min-h-screen">
            ...
            <div class="sticky top-0 z-30 bg-white/90 backdrop-blur-[2px] border-b border-slate-200 px-8 py-4 shadow-sm">
                <div class="flex items-center justify-between">
                    <!-- Page Title & Subtitle -->
                    <div>
                        <h2 class="text-3xl font-bold text-slate-800"><?php echo $__env->yieldContent('title'); ?></h2>
                        <p class="text-slate-500 mt-1"><?php echo $__env->yieldContent('subtitle'); ?></p>
                    </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div x-show="profileOpen"
                            ...
                            <?php if(request()->routeIs('member.profile')): ?>
...
<?php /**PATH C:\laragon\www\Project\club-panahan\resources\views\dashboards\member\_layout.blade.php ENDPATH**/ ?>