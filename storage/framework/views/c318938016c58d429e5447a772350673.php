<?php $__env->startSection('title', $achievement->title . ' - FocusOneX Archery'); ?>
...
<div class="min-h-screen bg-gradient-to-b from-[#1b2659] via-[#0f172a] to-[#16213a]">
    ...
    <div class="relative h-[50vh] md:h-[60vh] overflow-hidden">
        <!-- Background Image -->
        <img src="<?php echo e($achievement->photo_url ?? asset('asset/img/latarbelakanglogin.jpeg')); ?>" 
        ...
        <div class="absolute bottom-0 left-0 right-0 z-10 pb-12 pt-32">
            <div class="container mx-auto px-6">
                ...
                <div class="inline-flex items-center gap-2 bg-yellow-500/20 backdrop-blur-md border border-yellow-500/30 text-yellow-300 px-4 py-2 rounded-full text-sm font-semibold mb-4">
                    ...
                    ?>
                    <span class="text-2xl"><?php echo e($badge); ?></span>
                ...
                <div class="flex flex-wrap items-center gap-4 text-gray-300">
                    <?php if($achievement->type === 'member' && $achievement->member): ?>
                    <div class="flex items-center gap-2">
                        <svg class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z"/>
                        </svg>
                        <span class="font-semibold"><?php echo e($achievement->member->name); ?></span>
                    </div>
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <time datetime="<?php echo e($achievement->date->format('Y-m-d')); ?>">
                            <?php echo e($achievement->date->format('d F Y')); ?>
    ...
    <div class="container mx-auto px-6 py-12 md:py-16">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl">
                ...
                <div class="mb-6">
                    <?php if($achievement->type === 'member'): ?>
                ...
                <div class="prose prose-lg prose-invert max-w-none mb-8">
                    <div class="text-white/90 leading-relaxed space-y-4">
                        <?php echo nl2br(e($achievement->description)); ?>
                ...
                <div class="mt-8 pt-8 border-t border-white/10">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                            ...
                            <div class="text-white font-semibold text-lg"><?php echo e($achievement->member->name); ?></div>
                        </div>
                        <div class="bg-white/5 rounded-xl p-4 border border-white/10">
                            <div class="text-gray-400 text-sm mb-1">Achievement Date</div>
                            <div class="text-white font-semibold text-lg"><?php echo e($achievement->date->format('d F Y')); ?></div>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
            ...
            <div class="mt-8 text-center">
                <a href="<?php echo e(route('galeri')); ?>" class="inline-flex items-center gap-2 px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white rounded-2xl font-semibold transition-all">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function shareToWhatsApp() {
    const title = "<?php echo e($achievement->title); ?>";
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project\club-panahan\resources\views\pages\achievement-detail.blade.php ENDPATH**/ ?>