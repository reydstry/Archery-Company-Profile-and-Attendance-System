    ...
    <div class="w-full">
        <div class="flex items-center justify-between h-14 px-4">
            ...
            <a href="/" class="hidden md:flex items-center rounded-full px-2 py-1">
                <img src="<?php echo e(asset('asset/img/logowhite.png')); ?>" alt="FocusOnex Archery" 
                class="h-7 w-auto ">
            </a>
            ...
            ">
                <img src="<?php echo e(asset('asset/img/logowhite.png')); ?>" alt="FocusOnex Archery" class="h-7 w-auto">
            </a>
            ...
            <!-- Language Switch -->
                <div id="lang-switch" class="lang-switch flex items-center gap-1 p-1">
                    ...
                    <a href="<?php echo e(route('language.switch', 'id')); ?>"
                       class="lang-link text-xs <?php echo e(app()->getLocale() == 'id' ? 'lang-active' : ''); ?>">
                        ID
                    </a>
                    <a href="<?php echo e(route('language.switch', 'en')); ?>"
                       class="lang-link text-xs <?php echo e(app()->getLocale() == 'en' ? 'lang-active' : ''); ?>">
                        EN
                    </a>
...
<<<<<<< HEAD:storage/framework/views/18b99656e9ba59f8534689acf554ec78.php
</script>
<script>
...
<?php /**PATH C:\laragon\www\Project\club-panahan\resources\views/components/global/navbar.blade.php ENDPATH**/ ?>
=======
</script><?php /**PATH C:\laragon\www\Project-KP-Archery\resources\views/components/global/navbar.blade.php ENDPATH**/ ?>
>>>>>>> fix-bug:storage/framework/views/5ab63baa760aa025c18dced3c58ab8cd.php
