<?php $__env->startSection('title', $berita['title'] . ' - FocusOneX Archery'); ?>
        ...
        <div class="container mx-auto px-4 py-4">
            <nav>
                <ol class="flex items-center gap-2 text-sm text-gray-600">
                    <li><a href="<?php echo e(url('/')); ?>" class="hover:text-blue-600">Beranda</a></li>
                    <li>/</li>
                    <li><a href="<?php echo e(url('/galeri')); ?>" class="hover:text-blue-600">Galeri</a></li>
                    <li>/</li>
...
<div class="container mx-auto px-4 py-12">
    <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-8">
                ...
                <div class="flex flex-wrap items-center gap-4 text-sm text-gray-600 pb-6 border-b">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span><?php echo e($berita['date']); ?></span>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-12 text-center">
            <a href="<?php echo e(url('/galeri')); ?>" class="inline-flex items-center gap-2 border border-gray-300 text-gray-700 hover:bg-gray-100 px-8 py-3 rounded-lg font-semibold transition-all">
...
function shareToWhatsApp() {
    const title = "<?php echo e($berita['title']); ?>";
...
function shareToTwitter() {
    const title = encodeURIComponent("<?php echo e($berita['title']); ?>");
    const url = encodeURIComponent(window.location.href);
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project\club-panahan\resources\views/pages/berita-detail.blade.php ENDPATH**/ ?>