<?php $__env->startSection('title', 'Edit Training Session'); ?>
<?php $__env->startSection('subtitle', 'Update slot quotas for this day'); ?>
...
<div class="min-h-screen bg-white">
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-1.5 mb-2 card-animate" style="animation-delay: 0.1s">
        ...
        <a href="<?php echo e(route('coach.sessions.index')); ?>" class="w-full sm:w-auto px-3 py-1.5 bg-white hover:bg-slate-50 text-slate-700 rounded-lg font-medium border border-slate-200 transition-all duration-200 text-xs text-center">Back</a>
    </div>
...
<script>
const SESSION_ID = <?php echo json_encode($id ?? null, 15, 512) ?>;
...
async function confirmDeleteSession() {
    ...
    try {
        ...
        setTimeout(() => {
            window.location.href = '<?php echo e(route('coach.sessions.index')); ?>';
        }, 500);
    } catch (e) {
        console.error(e);
...
<?php echo $__env->make('layouts.coach', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Project\club-panahan\resources\views\dashboards\coach\sessions-edit.blade.php ENDPATH**/ ?>