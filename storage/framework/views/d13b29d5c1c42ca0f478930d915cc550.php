...
<div x-data="dashboardData()" x-init="loadData()" class="space-y-6">
    ...
    <div class="card-animate bg-white rounded-2xl border border-slate-200 shadow-sm" style="animation-delay: 0.4s">
        <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.members')); ?>" class="text-sm text-[#1a307b] hover:text-[#152866] font-medium">View All →</a>
        </div>
        <div class="p-6">
                                ...
                                <div class="flex items-center gap-4 shrink-0">
                                    <div class="text-right">
                                        ...
                                        <p class="font-bold text-slate-800">
                                            <span class="text-[#1a307b]" x-text="slot.total_attendance || 0"></span>
                                ...
                                <div class="p-4 bg-slate-50 grid-cols-1 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <template x-if="!slot.members || slot.members.length === 0">
                                            <p class="text-sm text-slate-500 italic">Belum ada data kehadiran</p>
                                        </template>
