            ...
            <div class="sticky top-0 z-30 bg-[#0b0b0f] border-b border-slate-800 px-4 sm:px-8 py-3 sm:py-[15px] shadow-sm">
                <div class="flex items-center justify-between gap-2">
                    <div class="flex flex-row items-center gap-3 md:gap-4 flex-1 min-w-0">
                        ...
                        <!-- Page Title & Subtitle -->
                        <div class="min-w-0">
                            <h2 class="text-lg sm:text-2xl lg:text-3xl font-bold text-white truncate">@yield('title')</h2>
                            <p class="text-slate-300 mt-0.5 text-[10px] sm:text-sm truncate">@yield('subtitle')</p>
                        </div>
                    </div>
